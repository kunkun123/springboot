...
import com.kun.sercurity.dao.SysResourceMapper;
...
public class CustomInvocationSecurityMetadataSourceService implements
	...
	@Autowired
	private SysResourceMapper sResourceVODao;
	
	@Autowired
	private SysRoleMapper sRoleVODao;
		...
		for (String auth : query) {
			...
			if(list1!=null && list1.size()>0) {
				for(Map<String, Object> map :list1){
					Object value = map.get("resourceString");
